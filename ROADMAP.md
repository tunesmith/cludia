...
Status: first usable slice (`init`, `add`, `edit`, `list`, `show`, `components`,
`component`, and `derive`) implemented on 2026-08-24; broader construction,
deletion, and defeat mutations remain.
